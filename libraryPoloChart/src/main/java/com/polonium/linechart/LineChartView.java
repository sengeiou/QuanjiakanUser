...
//                }
    ...
    private List<String> listHorizontalGraduate;
    private void setHorizontalGraduate(List<String> date){
        this.listHorizontalGraduate = date;
        postInvalidate();
    }
    ...
    private void drawValues(Canvas canvas) {
         ...
         * 自定义的刻度显示值
         */
//        drawHorizontalGraduateValues(canvas);
    }

    private void drawHorizontalGraduateValues(Canvas canvas) {
    ...
    private boolean onlyTwoPoint = true
            ;
    public void onlyTwoPointValueVer(){
        onlyTwoPoint = !onlyTwoPoint;
        postInvalidate();
    }
...
//                     * 纵向刻度，两端的值
//                     */
//                    if(y <= (firstHorLineY+mGrid.stepVer) || y>= (last - 2 * mGrid.stepVer)){
...
//                }
    ...
    public float getmViewPortMarginLeft() {
        return mViewPortMarginLeft;
    }

    public float getmViewPortMarginRight() {
        return mViewPortMarginRight;
    }

    public float getmViewPortMarginTop() {
        return mViewPortMarginTop;
    }

    public float getmViewPortMarginBottom() {
        return mViewPortMarginBottom;
    }

    public boolean getVerValuesAlign_Left(){
        return (mGrid.verValuesAlign & TextAlign.LEFT) > 0;
    }

    public boolean getVerValuesAlign_Top(){
        return (mGrid.verValuesAlign & TextAlign.TOP) > 0;
    }

    public boolean getVerValuesAlign_Right(){
        return(mGrid.verValuesAlign & TextAlign.RIGHT) > 0;
    }

    public boolean getVerValuesAlign_Bottom(){
        return (mGrid.verValuesAlign & TextAlign.BOTTOM) > 0;
    }

    public void setmGridverValuesAlign(int align){
        mGrid.verValuesAlign = align;
    }
}

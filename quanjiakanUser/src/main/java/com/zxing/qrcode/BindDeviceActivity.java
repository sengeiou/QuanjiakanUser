...
public class BindDeviceActivity extends BaseActivity implements Callback
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		showHint = getIntent().getBooleanExtra(BaseConstants.PARAMS_SHOW_HINT,false);
		// ��ʼ�� CameraManager
		CameraManager.init(getApplication());
		viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_view);
		bind_hint = (TextView) findViewById(R.id.bind_hint);
		if (showHint){
	...
	public void handleDecode(final Result obj, Bitmap barcode)
	{
		...
		//扫描成功
//		bindDevice(obj.getText());
		Intent intent = new Intent();
		intent.putExtra("deviceid",obj.getText());

...
import com.androidquanjiakan.view.SelectFootPrintPopupWindow;
...
/**
 * 作者：Administrator on 2017/4/11 11:24
 * <p>  足迹记录界面
 * 邮箱：liuzj@hi-board.com
 */


public class FootPrintRecordActivity extends BaseActivity implements AMap.OnMarkerClickListener,
    ...
    private RelativeLayout rlt_foot_record;
    private SelectFootPrintPopupWindow footPopupWindow;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_foot_print_record);
        ...
        if (device_id == null ||
            ...
            BaseApplication.getInstances().toast(FootPrintRecordActivity.this,"传入参数异常!");
            finish();
            return;
        }
        initStore();
...
//        List<DeviceRailEntity> list = DeviceRailHandler.getAllValue(device_id);
//        boolean isNeedUpdate = false;
//        for(DeviceRailEntity temp:list){
//            if(temp==null){
//                continue;
//            }
//            long savedTime = Long.parseLong((temp.getTime()!=null && temp.getTime().length()>0)?temp.getTime():(currentTime+""));
//            if(divTime<(currentTime-savedTime)){
//                isNeedUpdate = true;
//                break;
//            }
//        }
...
//                        getRailNumber();
    ...
    //设置电子围栏
    public void setEfence(String deviceId, List<LatLng> list, int position,String name) {
        ...
        try {
            ...
            jsonObjectSub.put("Num", list.size());
    ...
    public void getLocation() {
        if (!BaseApplication.getInstances().isSDKConnected()) {
            BaseApplication.getInstances().toast(FootPrintRecordActivity.this,"已与手表服务器断开连接");
            return;
        }
    ...
    public void initTitleBar() {
        ...
        rlt_foot_record = (RelativeLayout) findViewById(R.id.rlt_foot_record);
        rlt_foot_record.setVisibility(View.VISIBLE);
        rlt_foot_record.setOnClickListener(this);
        ...
        geocoderSearch.setOnGeocodeSearchListener(new GeocodeSearch.OnGeocodeSearchListener() {
            ...
            public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
                if (rCode == 1000) {
                    ...
                    BaseApplication.getInstances().showerror(FootPrintRecordActivity.this, rCode);
...
//                .defaultMarker());// 设置小蓝点的图标***不设置则使用默认
        ...
        aMap.setLocationSource(new LocationSource() {
            ...
            public void activate(OnLocationChangedListener onLocationChangedListener) {
                ...
                if (mlocationClient == null) {
                    mlocationClient = new AMapLocationClient(FootPrintRecordActivity.this);
    ...
    public void selfMarker(LatLng pLng, String address) {
        ...
        if (pageStatus == STATUS_SHOW) {
            ...
            marker = aMap.addMarker(new MarkerOptions()
                    .position(pLng)
                    .title(address)
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.map_location_old_16))
                    .draggable(true));
    ...
    public void openConfirmDialog() {
        if (confirmDialog != null && confirmDialog.isShowing()) {
            ...
            View view = LayoutInflater.from(this).inflate(R.layout.dialog_draw_digital_rail_confirm_old, null);
            ...
            confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(nameInput.length()<1){
                        Toast.makeText(FootPrintRecordActivity.this, "请输入围栏名称!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    confirmDialog.dismiss();
                    submitData(nameInput.getText().toString());
                    /**
                     * 根据围栏数判断菜单栏显示的样式
                     */
//                    reloadRailData();
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    confirmDialog.dismiss();
//                    BaseApplication.getInstances().toast("取消操作");
                    switch (pageWhich) {
                        case FIRST:
                            first.clear();
                            break;
...
//                    reDrawPolyline(pageWhich, lineStatus);
    ...
    public void submitData(String name) {
        switch (pageWhich) {
            case FIRST: {
                setEfence(device_id, first, FIRST, name);
                break;
            }
            case SECOND: {
                setEfence(device_id, second, SECOND, name);
                break;
            }
            case THIRD: {
                setEfence(device_id, third, THIRD, name);
                break;
            }
        }
    }
...
//    private DeviceRailEntity firstEntity = null;
//    private DeviceRailEntity secondEntity = null;
//    private DeviceRailEntity thirdEntity = null;
...
//            }
//            if (firstEntity != null) {
//                FootPrintRecordActivity.this.first = StringToListPoint(firstEntity);
//            }
//            if (secondEntity != null) {
//                FootPrintRecordActivity.this.second = StringToListPoint(secondEntity);
//            }
//            if (thirdEntity != null) {
//                FootPrintRecordActivity.this.third = StringToListPoint(thirdEntity);
//            }
//
...
//            if (firstEntity != null) {
//                View subItem1 = LayoutInflater.from(this).inflate(R.layout.item_watch_digitalrail_old, null);
//                final TextView subItemName1 = (TextView) subItem1.findViewById(R.id.name);
//                final ImageView subItemSwitch = (ImageView) subItem1.findViewById(R.id.switchbtn);
//                final ImageView subItemDelete1 = (ImageView) subItem1.findViewById(R.id.delete);
...
//                }
//                //TODO 首次显示切换开关，长按隐藏switch，显示删除按钮
//                subItemSwitch.setVisibility(View.VISIBLE);
//                subItemSwitch.setImageResource(R.drawable.enclosure_switch_open);
//                subItemSwitch.setTag("1");
//                //TODO 需要根据当前状态判断该电子围栏是开启，还是关闭---然后展示相应的图标
//
//
//
//                subItemDelete1.setVisibility(View.GONE);
...
//                    }
//                });
//                subItemName1.setOnLongClickListener(new View.OnLongClickListener() {
//                    @Override
//                    public boolean onLongClick(View v) {
//                        subItemSwitch.setVisibility(View.GONE);
...
//                    }
//                });
//                subItemSwitch.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        //TODO
//                        if(subItemSwitch.getTag()!=null && "1".equals(subItemSwitch.getTag().toString())){
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_close);
//                            subItemSwitch.setTag(null);
//                        }else{
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_open);
//                            subItemSwitch.setTag("1");
//                        }
...
//            } else {
//                View subItem2 = LayoutInflater.from(this).inflate(R.layout.item_watch_digitalrail_old, null);
...
//                        pageWhich = FIRST;
//                        lineStatus = POLYLINE_STATUS_UNFINISH;
//                        FootPrintRecordActivity.this.first.clear();
//                        moveCamera(new LatLng(mLat, mLon));
//                        selfMarker(new LatLng(mLat, mLon), mAddress);
//
//                    }
...
//                    public void onClick(View v) {
//                        //TODO
//                        if(subItemSwitch.getTag()!=null && "2".equals(subItemSwitch.getTag().toString())){
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_close);
//                            subItemSwitch.setTag(null);
//                        }else{
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_open);
...
//                        pageWhich = SECOND;
//                        lineStatus = POLYLINE_STATUS_UNFINISH;
//                        FootPrintRecordActivity.this.second.clear();
//                        moveCamera(new LatLng(mLat, mLon));
//                        selfMarker(new LatLng(mLat, mLon), mAddress);
//                    }
//                });
...
//                    public void onClick(View v) {
//                        //TODO
//                        if(subItemSwitch.getTag()!=null && "3".equals(subItemSwitch.getTag().toString())){
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_close);
//                            subItemSwitch.setTag(null);
//                        }else{
//                            subItemSwitch.setImageResource(R.drawable.enclosure_switch_open);
...
//                        pageWhich = THIRD;
//                        lineStatus = POLYLINE_STATUS_UNFINISH;
//                        FootPrintRecordActivity.this.third.clear();
//                        moveCamera(new LatLng(mLat, mLon));
//                        selfMarker(new LatLng(mLat, mLon), mAddress);
//                    }
//                });
...
//    }
            ...
            gaodeNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        NaviMapUtil.GotoGaoDeNaviMap(FootPrintRecordActivity.this, "全家康用户端", selfLatitude + "", selfLongitude + "", selfAdress, latLng.latitude + "", latLng.longitude + "",
                                (info_location.getTag() != null ? info_location.getTag().toString() : ""), "1", "0", "2");
                    } else {
                        BaseApplication.getInstances().toast(FootPrintRecordActivity.this,"暂未获取到自己的定位信息,请稍后重试!");
                    }
            ...
            baiduNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        ...
                        NaviMapUtil.GotoBaiDuNaviMap(FootPrintRecordActivity.this, selfBdlat + "," + selfBdlon, patitentBdLat + "," + patitentBdLon, "driving", null, null, null, null, null, "thirdapp.navi." + "巨硅科技" + R.string.app_name);
                    } else {
                        BaseApplication.getInstances().toast(FootPrintRecordActivity.this,"暂未获取到自己的定位信息,请稍后重试!");
                    }
                    selectNaviDialog.dismiss();
    ...
    public void onMapClick(LatLng latLng) {
        if (pageStatus == STATUS_EDIT) {
//            LogUtil.e("STATUS_EDIT 点击位置的 pageWhich："+pageWhich+"  纬度:"+latLng.latitude+" ** 经度:"+latLng.longitude);
            switch (pageWhich) {
                case WHICH_DEFAULT:
                    break;
                case FIRST:
                    ...
                    if (first.size() < SIZE_LIMIT) {
                        ...
                        BaseApplication.getInstances().toastLong(FootPrintRecordActivity.this,"超出可指定点的数量!");
                    }
                    //**展示所有点
                    //**连接所有线
...
//        reDrawPolyline(pageWhich,POLYLINE_STATUS_UNFINISH);
    ...
    private void showSelectPopupWindow() {
        ...
        footPopupWindow = new SelectFootPrintPopupWindow(FootPrintRecordActivity.this, itemsOnClick);

//        footPopupWindow.showDown(FootPrintRecordActivity.this.findViewById(R.id.layout_title));
        footPopupWindow.showAsDropDown(FootPrintRecordActivity.this.findViewById(R.id.layout_title));

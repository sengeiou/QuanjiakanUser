...
public class WatchCaseHistoryPicViewerActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(position<0){
            BaseApplication.getInstances().toast(WatchCaseHistoryPicViewerActivity.this,"参数异常!");
            finish();
            return;
        }
        initTitleBar();

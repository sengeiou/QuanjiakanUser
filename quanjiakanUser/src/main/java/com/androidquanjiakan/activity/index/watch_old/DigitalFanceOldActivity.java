...
public class DigitalFanceOldActivity extends BaseActivity implements AMap.OnMarkerClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (device_id == null ||
            ...
            BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"传入参数异常!");
            finish();
            return;
        }
        initStore();
...
//        }
    ...
    public void getLocation() {
        if (!BaseApplication.getInstances().isSDKConnected()) {
            BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"已与手表服务器断开连接");
            return;
        }
        ...
        geocoderSearch.setOnGeocodeSearchListener(new GeocodeSearch.OnGeocodeSearchListener() {
            ...
            public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
                if (rCode == 1000) {
                    ...
                    BaseApplication.getInstances().showerror(DigitalFanceOldActivity.this, rCode);
        ...
        aMap.setLocationSource(new LocationSource() {
            ...
            public void activate(OnLocationChangedListener onLocationChangedListener) {
                ...
                if (mlocationClient == null) {
                    mlocationClient = new AMapLocationClient(DigitalFanceOldActivity.this);
            ...
            confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(nameInput.length()<1){
                        Toast.makeText(DigitalFanceOldActivity.this, "请输入围栏名称!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    confirmDialog.dismiss();
...
//                    reloadRailData();
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    confirmDialog.dismiss();
//                    BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"取消操作");
                    switch (pageWhich) {
                        case FIRST:
                            first.clear();
                            break;
...
//                aMap.addPolyline(mPolyoptions);
    ...
    public void showDigitalRailPopWindow() {
        ...
        if (digitalRailList.size() > 0) {
            ...
            if (firstEntity != null) {
                DigitalFanceOldActivity.this.first = StringToListPoint(firstEntity);
            }
            if (secondEntity != null) {
                DigitalFanceOldActivity.this.second = StringToListPoint(secondEntity);
            }
            if (thirdEntity != null) {
                DigitalFanceOldActivity.this.third = StringToListPoint(thirdEntity);
            }
...
//                        getRailNumber();
                ...
                subItem2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        pageWhich = FIRST;
                        lineStatus = POLYLINE_STATUS_UNFINISH;
                        DigitalFanceOldActivity.this.first.clear();
                        moveCamera(new LatLng(mLat, mLon));
                        selfMarker(new LatLng(mLat, mLon), mAddress);
...
//                        getRailNumber();
                ...
                subItem2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        pageWhich = SECOND;
                        lineStatus = POLYLINE_STATUS_UNFINISH;
                        DigitalFanceOldActivity.this.second.clear();
                        moveCamera(new LatLng(mLat, mLon));
                        selfMarker(new LatLng(mLat, mLon), mAddress);
                    }
                });
...
//                        DeviceRailHandler.remove(device_id, TableInfo_ValueStub.DEVICE_RAIL_INFO_THIRD, "");
                        ...
                        pageWhich = THIRD;
                        lineStatus = POLYLINE_STATUS_UNFINISH;
                        DigitalFanceOldActivity.this.third.clear();
                        moveCamera(new LatLng(mLat, mLon));
                        selfMarker(new LatLng(mLat, mLon), mAddress);
                    }
                });
            ...
            gaodeNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        NaviMapUtil.GotoGaoDeNaviMap(DigitalFanceOldActivity.this, "全家康用户端", selfLatitude + "", selfLongitude + "", selfAdress, latLng.latitude + "", latLng.longitude + "",
                                (info_location.getTag() != null ? info_location.getTag().toString() : ""), "1", "0", "2");
                    } else {
                        BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"暂未获取到自己的定位信息,请稍后重试!");
                    }
            ...
            baiduNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        ...
                        NaviMapUtil.GotoBaiDuNaviMap(DigitalFanceOldActivity.this, selfBdlat + "," + selfBdlon, patitentBdLat + "," + patitentBdLon, "driving", null, null, null, null, null, "thirdapp.navi." + "巨硅科技" + R.string.app_name);
                    } else {
                        BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"暂未获取到自己的定位信息,请稍后重试!");
                    }
                    selectNaviDialog.dismiss();
            ...
            switch (pageWhich) {
                ...
                case FIRST:
                    ...
                    if (first.size() < SIZE_LIMIT) {
                        ...
                        BaseApplication.getInstances().toastLong(DigitalFanceOldActivity.this,"超出可指定点的数量!");
                    }
                    //**展示所有点
                    //**连接所有线
...
//        reDrawPolyline(pageWhich,POLYLINE_STATUS_UNFINISH);
    ...
    private void toFootPrintRecord() {
        Intent intent = new Intent();
        intent.setClass(DigitalFanceOldActivity.this,FootPrintRecordActivity.class);
        ...
        intent.putExtra(BaseConstants.PARAMS_DEVICE_PHONE, phoneNumberString);
        startActivity(intent);
                ...
                switch (currentCommand) {
                    case MainEntryMapActivity.SET_EFENCE: {
                        ...
                        if (result != null && "200".equals(result.getResults().getCode())) {
                            ...
                            BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"设备不在线");
                        } else if (result != null && "10009".equals(result.getResults().getCode())) {
                            BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"已存在围栏，请删除后再设置!");
                        } else {
                            BaseApplication.getInstances().toast(DigitalFanceOldActivity.this,"设置围栏失败 ");
                        }
                        break;
                    }

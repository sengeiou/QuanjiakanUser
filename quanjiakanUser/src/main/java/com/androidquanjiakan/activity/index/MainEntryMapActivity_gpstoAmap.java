...
public class MainEntryMapActivity_gpstoAmap extends BaseActivity implements AMap.OnMarkerClickListener,
        ...
        aMap.setLocationSource(new LocationSource() {
            ...
            public void activate(OnLocationChangedListener onLocationChangedListener) {
                ...
                if (mlocationClient == null) {
                    mlocationClient = new AMapLocationClient(MainEntryMapActivity_gpstoAmap.this);
...
//        deviceEntityList = BaseApplication.getInstances().getDaoInstant().getWatchMapDevice_DeviceInfoDao().loadAll();
        mAdapter = new DeviceContainerAdapter(MainEntryMapActivity_gpstoAmap.this, deviceEntityList);
    ...
    public void getNetFamilyBindData() {
        ...
        if (LogUtil.BINDDEVICE_OFF) {
            ...
            MyHandler.putTask(MainEntryMapActivity_gpstoAmap.this, new Task(new HttpResponseInterface() {
                @Override
...
//                    {"Result":{"Category":"WatchList","WatchList":[{"IMEI":"240207489224233264","Location":"113.2409402,23.1326885","Name":"爸爸","Online":"0","Picture":"image","Time":"2017-01-01 00:00:00"}]}}
                    ...
                    //{"code":202,"message":"结果集为空"}
                        ...
                        locateSelf(LOCATION_TYPE_SHOW_AND_MOVE_POSITION);
                        showTipsDialog();
                        BaseApplication.getInstances().toast(MainEntryMapActivity_gpstoAmap.this,"暂无绑定设备");
    ...
    public void getLocation(String deviceId) {
        try {
            if (!BaseApplication.getInstances().isSDKConnected()) {
                BaseApplication.getInstances().toast(MainEntryMapActivity_gpstoAmap.this,"已与手表服务器断开连接");
                return;
            }
    ...
    public void toActive(){
        Intent intent = new Intent(MainEntryMapActivity_gpstoAmap.this, CommonWebEntryActivity_kitkat.class);
        ...
        if (NaviMapUtil.isAvilible(this, "com.autonavi.minimap")) {
            ...
            gaodeNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        NaviMapUtil.GotoGaoDeNaviMap(MainEntryMapActivity_gpstoAmap.this, "全家康用户端", selfLatitude + "", selfLongitude + "", selfAdress, latLng.latitude + "", latLng.longitude + "",
                                (info_location.getTag() != null ? info_location.getTag().toString() : ""), "1", "0", "2");
                    } else {
                        BaseApplication.getInstances().toast(MainEntryMapActivity_gpstoAmap.this,"暂未获取到自己的定位信息,请稍后重试!");
                        locateSelf(LOCATION_TYPE_GET_POSITION);
                    }
            ...
            baiduNavi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (selfLatitude != -1000 && selfLongitude != -1000) {
                        ...
                        NaviMapUtil.GotoBaiDuNaviMap(MainEntryMapActivity_gpstoAmap.this, selfBdlat + "," + selfBdlon, patitentBdLat + "," + patitentBdLon, "driving", null, null, null, null, null, "thirdapp.navi." + "巨硅科技" + R.string.app_name);
                    } else {
                        BaseApplication.getInstances().toast(MainEntryMapActivity_gpstoAmap.this,"暂未获取到自己的定位信息,请稍后重试!");
                    }
                    selectNaviDialog.dismiss();
    ...
    public void showTipsDialog() {
        if (BaseApplication.getInstances().getKeyValue(keyTips) != null &&
            ...
            btn_confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (tipsDialog != null) {
                        Intent intent = new Intent(MainEntryMapActivity_gpstoAmap.this, DevicesBindActivity.class);
                        intent.putExtra(DevicesBindActivity.TYPE,"child");
                        startActivityForResult(intent, REQUEST_BIND);
                        tipsDialog.dismiss();
                    }
...
//                    }
            ...
            case NattyProtocolFilter.DISPLAY_UPDATE_DATA_RESULT: {
                ...
                switch (currentCommand) {
                    case MainEntryMapActivity_gpstoAmap.GET_LOCATION: {
...
//                                BaseApplication.getInstances().toast(MainEntryMapActivity.this,"获取地址成功");
                            ...
                            BaseApplication.getInstances().toast(MainEntryMapActivity_gpstoAmap.this,"设备不在线");
//                            locateSelf(LOCATION_TYPE_SHOW_AND_MOVE_POSITION);
                        } else {

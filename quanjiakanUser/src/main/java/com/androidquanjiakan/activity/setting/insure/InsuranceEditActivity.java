...
public class InsuranceEditActivity extends BaseActivity implements OnClickListener{
	...
	public void submit(){
		...
		Toast.makeText(InsuranceEditActivity.this, ""+sb.toString(), Toast.LENGTH_SHORT).show();
	}

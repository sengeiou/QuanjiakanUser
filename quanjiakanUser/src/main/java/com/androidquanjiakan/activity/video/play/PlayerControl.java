...
public class PlayerControl {
    ...
    private String getStatus(int status) {
        switch (status) {
            case VideoDemandPlayActivity.STATUS_PAUSE:
                return "pause";
            case VideoDemandPlayActivity.STATUS_RESUME:
                return "resume";
            case VideoDemandPlayActivity.STATUS_START:
                return "start";
            case VideoDemandPlayActivity.STATUS_STOP:
                return "stop";
        }
    ...
    public PlayerControl(Activity activity) {
        ...
        if(activity instanceof VideoDemandPlayActivity){
            ((VideoDemandPlayActivity)activity).setStatusListener(mStatusListerner);
        }

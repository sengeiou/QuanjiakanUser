...
public class MaterialBadgeTextView extends TextView {
    ...
    public void setHighLightMode(boolean isDisplayInToolbarMenu) {
        ...
        params.width = dp2px(getContext(), 12);
        params.height = params.width;
        if (isDisplayInToolbarMenu && params instanceof FrameLayout.LayoutParams) {
            ((FrameLayout.LayoutParams) params).topMargin = dp2px(getContext(), 12);
            ((FrameLayout.LayoutParams) params).rightMargin = dp2px(getContext(), 12);
        }
    ...
    class SemiCircleRectDrawable extends Drawable {
        ...
        public void setBounds(int left, int top, int right, int bottom) {
            ...
            if (rectF == null) {
                rectF = new RectF(left + diffWH, top + mShadowRadius + 2, right - diffWH, bottom - mShadowRadius - 2);
            } else {
                rectF.set(left + diffWH, top + mShadowRadius + 2, right - diffWH, bottom - mShadowRadius - 2);
            }
        }

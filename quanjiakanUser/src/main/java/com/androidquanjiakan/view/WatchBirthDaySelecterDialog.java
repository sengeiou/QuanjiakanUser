 ...
 *
 */
public class WatchBirthDaySelecterDialog extends Dialog implements View.OnClickListener {
	...
	public WatchBirthDaySelecterDialog(Context context) {
		super(context, R.style.ShareDialog);
		this.context = context;
	}

	public WatchBirthDaySelecterDialog(Context context,boolean cycle) {
		super(context, R.style.ShareDialog);
		this.context = context;
		this.isCycle = cycle;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View contentView = LayoutInflater.from(context).inflate(R.layout.dialog_watch_birthday,null);
		setContentView(contentView,lp);

//		setContentView(R.layout.dialog_watch_birthday);
		...
		wvMonth.setCyclic(isCycle);
		wvDay.setCyclic(isCycle);
		...
		wvYear.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				setTextviewSize(currentText.replace("年",""), mYearAdapter);
				currentYear = Integer.parseInt(currentText.replace("年",""));
				setYear(currentYear);
				initMonths(month);
		...
		wvMonth.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				setTextviewSize(currentText.replace("月",""), mMonthAdapter);
				setMonth(Integer.parseInt(currentText.replace("月","")));
				initDays(day);

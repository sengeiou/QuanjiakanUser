 ...
 */
public class ClinicClassifyAdapter extends BaseAdapter {
    private List<ClinicClassifyEntity> data;
    private Context context;

    public ClinicClassifyAdapter(Context context, List<ClinicClassifyEntity> list){
        if(list==null){
            data = new ArrayList<ClinicClassifyEntity>();
        }
        data = list;
        this.context = context;
    }

    public List<ClinicClassifyEntity> getData(){
        return data;
    }

    public void setData(List<ClinicClassifyEntity> data) {
        this.data = data;
    }

...
public class HealthDocumentAdapter extends BaseAdapter {
    ...
    private List<HealthDocumentEntity> data;
    private Context context;

    public HealthDocumentAdapter(Context context,List<HealthDocumentEntity> data){
        this.context = context;
        this.data = data;
    }

    public List<HealthDocumentEntity> getData() {
        return data;
    }

    public void setData(List<HealthDocumentEntity> data) {
        this.data = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final HealthDocumentEntity entity = data.get(position);
...
//            ImageLoadUtil.loadImage(holder.image,entity.getMedical_record(),null);
        ...
        if(entity!=null && entity.getCreatetime()!=null){
            holder.time.setText("发布时间: "+entity.getCreatetimeFormat());
        }else{
            holder.time.setText("");
        }
        return convertView;

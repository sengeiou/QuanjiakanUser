...
public class RightVoiceView extends RelativeLayout{
	private ImageView image,image_anim;
	private TextView tv;
	private DisplayImageOptions options;
	
	public RightVoiceView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		View view = LayoutInflater.from(context).inflate(R.layout.item_voice_detail_right, null);

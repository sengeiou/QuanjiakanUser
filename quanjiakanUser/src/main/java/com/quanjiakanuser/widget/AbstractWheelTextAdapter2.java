 ...
 */
public abstract class AbstractWheelTextAdapter2 extends AbstractWheelAdapter2 {
	 ...
	 *            the current context
	 */
	protected AbstractWheelTextAdapter2(Context context) {
	 ...
	 */
	protected AbstractWheelTextAdapter2(Context context, int itemResource) {
	 ...
	 */
	protected AbstractWheelTextAdapter2(Context context, int itemResource, int itemTextResource, int currentIndex,
...
//					textView.setTextColor(context.getResources().getColor(R.color.color_xun_ing));
//				} else {
//					textView.setTextSize(minsize);
//					textView.setTextColor(context.getResources().getColor(R.color.font_color_999999));
//				}

				if (getItemText(index).toString().contains("秒")) {
					textView.setTextSize(minsize);
					textView.setTextColor(context.getResources().getColor(R.color.color_xun_ing));
				} else {
					textView.setTextSize(maxsize);

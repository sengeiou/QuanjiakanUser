...
//    }
    ...
    public String getTime() {
        long currentTime = /*Configs.getReportTime()*/System.currentTimeMillis();
    ...
    public static final String formatTime_For_mSecond(long mSecond){
        if(mSecond<=0){
            return "0秒";
        }else if(mSecond<60000){
            return (mSecond/1000f)+"秒";
        }else if(mSecond<3600000){
            return (mSecond/60000)+"分"+((mSecond%60000)/1000)+"秒";
        }else if(mSecond>=3600000){
            long hour = mSecond/3600000;
            long minute = mSecond%3600000;
            return (hour)+"小时"+(minute/60000)+"分"+((minute%60000)/1000)+"秒";
        }
        return "";
    }
